...
def get_args_parser():
    ...
    # * Finetuning params 
    parser.add_argument('--finetune', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm/checkpoint-199.pth',
    ...
    # Dataset parameters 
    # TODO
    parser.add_argument('--data_path', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_trainCloud/', type=str,
                        help='dataset path')
    parser.add_argument('--data_pathVal', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_valCloud/', type=str,
                        help='dataset path')
    #parser.add_argument('--data_pathTest', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_testCloud/', type=str,
    #                    help='dataset path')
    parser.add_argument('--data_pathTest', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_testNEW/', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=19, type=int,
                        help='number of the classification types')

    parser.add_argument('--output_dir', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BENCloud/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BENCloud/',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BENCloud/checkpoint-99.pth',
                        help='resume from checkpoint')

    parser.add_argument('--start_epoch', default=99, type=int, metavar='N',
                        help='start epoch')
    ...
    parser.add_argument("--is_slurm_job", action='store_true', help="slurm job", default=False)
    parser.add_argument("--train_frac", default=1.0, type=float, help="use a subset of labeled data")
    parser.add_argument("--fine_tune", action='store_true', default=True, help="fine tune or not")
...
def main(args):
    ...
    dataset_val = LMDBDataset(
        lmdb_file=args.data_pathVal,
        transform=val_transforms,
        is_slurm_job=args.is_slurm_job            
    )   

    dataset_test = LMDBDataset(
        lmdb_file=args.data_pathTest,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #if epoch%4==0 or (epoch + 1 == args.epochs):
