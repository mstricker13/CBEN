...
parser.add_argument('--dataTrain', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_trainNEW/',
                    help='path to dataset')
parser.add_argument('--dataVal', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_valNEW/',
                    help='path to dataset')
...
parser.add_argument('--resume', default='/data/Phd_data/Projects/SSL/output/ssl4eo/moco3BEN/checkpoint_99.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--dist_url', default="file:///code/ddd/ddpmoco3vitBEN", type=str,
...
parser.add_argument('--checkpoints_dir', default="/data/Phd_data/Projects/SSL/output/ssl4eo/moco3BEN/", help='Path to save logs and checkpoints')
