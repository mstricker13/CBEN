...
parser.add_argument('--lmdb_dir_train', type=str, default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_trainCloud/')
parser.add_argument('--lmdb_dir_val', type=str, default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_valCloud/')
...
parser.add_argument('--checkpoints_dir', type=str, default='/data/Phd_data/Projects/SSL/output/ssl4eo/moco2BENCloud/')
parser.add_argument('--resume', type=str, default='/data/Phd_data/Projects/SSL/output/ssl4eo/moco2BENCloud/checkpoint_0099.pth.tar')
...
### distributed running ###
parser.add_argument('--dist_url', default="file:///code/ddd/ddpmoco2res50BENcloud", type=str)
