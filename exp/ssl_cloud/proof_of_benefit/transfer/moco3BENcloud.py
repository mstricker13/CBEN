...
parser.add_argument('--dataTrain', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_trainCloud/',
                    help='path to dataset')
parser.add_argument('--dataVal', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_valCloud/',
                    help='path to dataset')
parser.add_argument('--dataTest', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_testNEW/',
                    help='path to dataset')
#parser.add_argument('--dataTest', metavar='DIR', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_testCloud/',
#                    help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default='vit_small',
                    ...
                    help='model architecture: ' +
                        ' | '.join(model_names) +
                        ' (default: resnet50)')
parser.add_argument('-j', '--num_workers', default=10, type=int, metavar='N',
...
parser.add_argument('--resume', default='/data/Phd_data/Projects/SSL/output/ssl4eo/moco3BENcloud/checkpoint_99.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--dist_url', default="file:///code/ddd/ddpmoco3vitBENcloud", type=str,
...
# additional configs:
parser.add_argument('--pretrained', default="/data/Phd_data/Projects/SSL/output/ssl4eo/ddpmoco3vit/checkpoint_0099.pth.tar", type=str,
...
parser.add_argument('--checkpoints_dir', default="/data/Phd_data/Projects/SSL/output/ssl4eo/moco3BENcloud/", help='Path to save logs and checkpoints')
parser.add_argument("--is_slurm_job", action='store_true', default=False, help="slurm job")

parser.add_argument('--schedule', default=[60, 80], nargs='*', type=int,
                    help='learning rate schedule (when to drop lr by 10x)')
parser.add_argument('--cos', action='store_true', help='use cosine lr schedule',default=True)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.arch.startswith('vit'):
        model = vits.__dict__[args.arch](in_chans=14,num_classes=19)
        linear_keyword = 'head'
    else:
    ...
    if args.bands == 'RGB':
        ...
        lmdb_train = args.dataTrain
        lmdb_val = args.dataVal
        lmdb_test = args.dataTest
        args.n_channels = 14
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch%2==1 and args.rank==0: # only the first GPU saves checkpoint
            save_checkpoint({
                'epoch': epoch + 1,
                'arch': args.arch,
            ...
            }, is_best,filename=os.path.join(args.checkpoints_dir,f'checkpoint_{epoch}.pth.tar'))
