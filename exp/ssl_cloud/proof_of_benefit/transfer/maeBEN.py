...
def get_args_parser():
    ...
    # Dataset parameters 
    # TODO
    parser.add_argument('--data_path', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_trainNEW/', type=str,
                        help='dataset path')
    parser.add_argument('--data_pathVal', default='/data/Phd_data/Projects/SSL/data/BigEarthNet_lmdb_valNEW/', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BEN/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BEN/',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='/data/Phd_data/Projects/SSL/output/ssl4eo/mae_vit_mm_BEN//checkpoint-99.pth',
