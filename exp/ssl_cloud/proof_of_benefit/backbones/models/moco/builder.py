...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, mlp=False, bands='all'):
        ...
        if bands=='B12':
            ...
            self.encoder_q.conv1 = torch.nn.Conv2d(14,64,kernel_size=(7,7),stride=(2,2),padding=(3,3),bias=False)
            self.encoder_k.conv1 = torch.nn.Conv2d(14,64,kernel_size=(7,7),stride=(2,2),padding=(3,3),bias=False)
